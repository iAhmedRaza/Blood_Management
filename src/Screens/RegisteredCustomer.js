    ...
    return (
        <View style={styles.container}>
            <View style={styles.card}>
                <View style={{marginTop: 20, marginRight: 30}}><Text style={{fontSize: 35, color: 'grey',fontStyle: 'italic'}}>1)</Text></View>
                <View>
                <Text style={{fontStyle: 'italic', color: 'grey'}}>Name: {name} </Text>
                <Text style={{fontStyle: 'italic', color: 'grey'}}>Country:</Text>
                <Text style={{fontStyle: 'italic', color: 'grey'}}>Blood Group:</Text>
                <Text style={{fontStyle: 'italic', color: 'grey'}}>Email:</Text>
                <Text style={{fontStyle: 'italic', color: 'grey'}}>Password: </Text>
                </View>
